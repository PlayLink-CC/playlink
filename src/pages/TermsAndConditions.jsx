    ...
    <div className="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <header className="bg-linear-to-r from-green-50 to-white rounded-xl p-6 shadow-sm mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Please read these terms carefully before using PlayLink’s court
          booking services.
        </p>
        ...
        <nav className="md:col-span-1 sticky top-24 self-start">
          <div className="hidden md:block bg-white border rounded-lg p-4 shadow">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#bookings" className="text-green-600 hover:underline">
                  Bookings & Payments
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#conduct" className="text-green-600 hover:underline">
                  User Conduct
                </a>
              </li>
              <li>
                <a href="#liability" className="text-green-600 hover:underline">
                  Liability
                </a>
              </li>
              <li>
                <a href="#changes" className="text-green-600 hover:underline">
                  Changes to Terms
                </a>
              </li>
              <li>
        ...
        <main className="md:col-span-3">
          <article className="space-y-6">
            <section id="acceptance" className="prose max-w-none">
              <h2>Acceptance</h2>
              <p>
                By accessing or using PlayLink, you agree to these Terms &
            ...
            <section id="eligibility" className="prose max-w-none">
              <h2>Eligibility</h2>
              <p>
                Users must be 18 years or older, or have parental/guardian
                consent to use PlayLink's services. You agree to provide
            ...
            <details id="bookings" className="group border rounded-lg p-4" open>
              ...
              <div className="mt-3 text-gray-700 space-y-2">
                <p>
                  All bookings are subject to availability. When you make a
                  booking, you agree to provide current and accurate
                  information. Prices and availability displayed are provided by
                  the venues.
                </p>
                <p>
                  Payments are processed securely via Stripe. We do not store
                  your full card details; Stripe handles payment authorization
                  and storage. By making a booking you authorize us to charge
            ...
            <details id="cancellation" className="group border rounded-lg p-4">
              ...
              <div className="mt-3 text-gray-700 space-y-2">
                <p>
                  Cancellations should be made within the timeframe shown when
                  booking. Unless otherwise stated, cancellations made less than
                  24 hours before the booking may not be eligible for a refund.
                </p>
                <p>
                  Any refunds will be handled in accordance with the venue
                  policy and payment processor rules.
                </p>
              </div>
            </details>
            ...
            <details id="conduct" className="group border rounded-lg p-4">
              ...
              <div className="mt-3 text-gray-700 space-y-2">
                <p>
                  You are expected to follow venue rules and behave
                  respectfully. PlayLink reserves the right to suspend or
                  terminate accounts for misconduct.
                </p>
              </div>
            </details>
            ...
            <details id="liability" className="group border rounded-lg p-4">
              ...
              <div className="mt-3 text-gray-700 space-y-2">
                <p>
                  PlayLink provides a platform to connect users with venues. We
                  are not responsible for injuries, losses, or damages that
                  occur at venues. Use of venues is at your own risk.
                </p>
              </div>
            </details>
            ...
            <section id="changes" className="prose max-w-none">
              ...
              <p>
                ...
                the revised terms here with a new effective date. Continued use
            ...
            <section id="contact" className="prose max-w-none">
              ...
              <p>
                ...
                at{" "}
                <a href="mailto:support@playlink.example">
                  support@playlink.example
                </a>
                .
              </p>
            </section>
